				...
				<div id="column_center">
					<?php
						...
						while($query2=mysqli_fetch_array($query1))
						{
							...
							echo "<div id='center4'><center><h3>Votos:</h3><br />".$query2['totalVotos']."</center></div>";
							echo "<div id='center5'><center><a href='edit.php?codReceita=".$query2['codReceita']."'><img src='Image/edit.png' border='0' width='50' height='50'/></a></center></div>";
							echo "<div id='center5'><center><a href='delete.php?codReceita=".$query2['codReceita']."'><img src='Image/excluir.png' border='0' width='50' height='50'/></a></center></div><br /><br /><br /><br /><br /><br />";
						}
