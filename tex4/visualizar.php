			...
			<div id="main">
				...
				<div id="column_center">
					...
					<form method="post" action="">
						<span style="float: left; margin-left: 30%;"><h4>Nome da receita:&nbsp;</h4></span>
						<input type="text" name="nomeReceita" value="<?php echo $query2['nomeReceita'];?>" readonly>
						<br />
						<br />
						<span style="float: left; margin-left: 32.4%;"><h4>Ingredientes:&nbsp;</h4></span> 
						<textarea name="ingredientes" rows="10" cols="50" readonly><?php echo $query2['ingredientes'];?></textarea>
						<br />
						<br />
						<span style="float: left; margin-left: 29.4%;"><h4>Modo de Preparo:&nbsp;</h4></span> 
						<textarea name="modoPreparo" rows="20" cols="70" readonly><?php echo $query2['modoPreparo'];?></textarea>
						<br />
						
						<span style="float: left; margin-left: 29%;"><h4>Tempo de preparo:&nbsp;</h4></span>
						...
						<br />
						<br />
						<span style="float: left; margin-left: 34%;"><h4>Categoria:&nbsp;</h4></span>
