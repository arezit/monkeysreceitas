			...
			<div id="main">
				...
				<div id="column_center">
					<?php
						...
						$query1=mysqli_query($conn,"SELECT codReceita, nomeReceita, totalVotos FROM receita WHERE codCategoria LIKE 3 ORDER BY totalVotos desc, nomeReceita asc  LIMIT 5; ");
